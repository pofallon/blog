 ...
 */
export type GetPostBySlugFn = (slug: string) => Promise<BlogPostDocument | null>;

/**
 * Transform document to view model
 */
export type TransformToPageModelFn = (
 ...
 */
export type GetAllPostSlugsFn = () => Promise<string[]>;

/**
 * Generate SEO metadata from page model
 */
export type GeneratePostMetadataFn = (
